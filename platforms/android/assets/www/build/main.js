...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__terms_terms__ = __webpack_require__(281);
...
var RegisterPage = (function () {
    function RegisterPage(navCtrl, navParams, popoverCtrl, viewCtrl, authService, loadingCtrl, formBuilder) {
    ...
    RegisterPage.prototype.signup = function (form) {
        ...
        //Api Connections
        this.showLoader();
        this.authService.signup({ formData: form.value }, "sign_up").then(function (result) {
...
RegisterPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-register',template:/*ion-inline-start:"/Users/mobileapps/Desktop/BPCI-final/BPCI/src/pages/register/register.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>New User Registration</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="form-content" padding>\n  <div class="login-box">\n\n    <form #registerForm="ngForm" (ngSubmit)="signup(registerForm)">\n      <ion-row>\n        <ion-col>\n          <ion-label text-left>Account Information</ion-label>\n          <ion-list>\n            <ion-item>\n              <ion-input type="text" ngModel name="username" placeholder="Username" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="password" ngModel ngControl=\'password\' placeholder="Password" name="password" required></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-input type="password" ngControl=\'repeat\' placeholder="Confirm Password" name="confirm-password" id=\'repeat\' required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="email" ngModel placeholder="Email Address" name="email" required></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-input type="email" placeholder="Confirm E-mail Address" name="confirm-email" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="text" ngModel placeholder="Name" name="name" required></ion-input>\n            </ion-item>\n            <ion-input>\n              <ion-input type="hidden" [(ngModel)]="userData.device_id" name="device_id" required></ion-input>\n              <ion-input type="hidden" [(ngModel)]="userData.device_type" name="device_type" required></ion-input>\n            </ion-input>\n\n          </ion-list>\n        </ion-col>\n      </ion-row>\n\n      <ion-row>\n        <ion-col>\n          <ion-label text-left>More Information</ion-label>\n          <ion-list>\n            <ion-item>\n              <ion-input type="text" ngModel placeholder="Organization Name" name="organization_name" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="text" ngModel placeholder="Adress" name="address" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="text" ngModel placeholder="City" name="city" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="text" ngModel placeholder="State" name="state" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="text" ngModel placeholder="Zip Code" name="zip_code" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="phone" ngModel placeholder="Primary Mobile Number for alerts" name="primary_contact" required></ion-input>\n            </ion-item>\n\n            <ion-item>\n              <ion-input type="phone" ngModel placeholder="Contact Phone Number" name="organization_business_phone" required></ion-input>\n            </ion-item>\n\n          </ion-list>\n        </ion-col>\n      </ion-row>\n\n      <ion-row>\n        <ion-col class="signup-col">\n          <button ion-button class="submit-btn theme-btn" full type="submit" [disabled]="!registerForm.form.valid">Register</button>\n          <button ion-button class="terms-btn" block clear color="secondary" (click)="terms_popup()" type="button">Terms & Condition</button>\n        </ion-col>\n      </ion-row>\n\n    </form>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/mobileapps/Desktop/BPCI-final/BPCI/src/pages/register/register.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_auth_service_user_data__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_service_user_data__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SettingsPage = (function () {
    function SettingsPage(navCtrl, navParams, authServices, userdata) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
...
var NotificationsPage = (function () {
    function NotificationsPage(navCtrl, navParams, authService, userData) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authService = authService;
        this.userData = userData;
...
var AddPatientPage = (function () {
    function AddPatientPage(navCtrl, navParams, authService, loadingCtrl, user_data) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authService = authService;
    ...
    AddPatientPage.prototype.addPatient = function (form) {
        ...
        this.authService.addPatient({ formData: form.value }, 'add_patient')
            .then(function (result) {
            _this.loading.dismiss();
...
var AddManualeventPage = (function () {
    function AddManualeventPage(navCtrl, navParams, authService, userdata, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authService = authService;
        this.userdata = userdata;
    ...
    AddManualeventPage.prototype.showLoader = function () {
        this.loading = this.loadingCtrl.create({
            content: 'Loading...'
        });
        this.loading.present();
...
AddManualeventPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-add-manualevent',template:/*ion-inline-start:"/Users/mobileapps/Desktop/BPCI-final/BPCI/src/pages/add-manualevent/add-manualevent.html"*/'<ion-header>\n  <ion-navbar color="primary" hideBackButton="true">\n    <ion-buttons start>\n      <button ion-button icon-only menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>Add Manual Event</ion-title>\n  </ion-navbar>\n  <ion-toolbar *ngIf="showSearchbar">\n    <ion-searchbar></ion-searchbar>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class="form-content" padding>\n\n  <ion-row *ngIf="userCollection" text-left>\n    <form (ngSubmit)="addManualReport(reportForm)" #reportForm="ngForm">\n      <ion-note>\n        <p>Allows users to enter and track manual patient\n          events (encounters) without using SMS Text/Voice\n          feature.</p>\n      </ion-note>\n      <h2>Please Select Patient *</h2>\n      <ion-list>\n        <ion-item>\n          <ion-select [(ngModel)]="EntryId" name="EntryId" id="EntryId" placeholder="Please select anyone patient">\n            <ion-option *ngFor="let patient of userCollection.response.patient_data" value="{{ patient.p_id }}" >{{ patient.p_name }}</ion-option>\n          </ion-select>\n        </ion-item>\n      </ion-list>\n\n      <h2>Message</h2>\n      <ion-list>\n        <ion-item>\n          <ion-input ngModel name="message" id="message" type="text" placeholder=""></ion-input>\n        </ion-item>\n      </ion-list>\n\n      <h2>Date(YY/MM/DD) *</h2>\n      <ion-item>\n        <ion-label>Select date</ion-label>\n        <ion-datetime [(ngModel)]="entrydate" id="entrydate" name="entrydate"><input type="datetime-local"> </ion-datetime>\n      </ion-item>\n\n      <button ion-button type="submit">Submit</button>\n    </form>\n  </ion-row>\n</ion-content>\n'/*ion-inline-end:"/Users/mobileapps/Desktop/BPCI-final/BPCI/src/pages/add-manualevent/add-manualevent.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_2__providers_auth_service_auth_service__["a" /* AuthServiceProvider */],
...
var AlertFrequencyPage = (function () {
    function AlertFrequencyPage(navCtrl, navParams, authService, userData, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authService = authService;
        this.userData = userData;
    ...
    AlertFrequencyPage.prototype.ngOnInit = function () {
        ...
        this.authService.postData({ user_id: this.userID }, 'get_frequency_alert')
            ...
            if (_this.data.indexOf('Thrusday') !== -1) {
                _this.thrusday = true;
            }
    ...
    AlertFrequencyPage.prototype.showLoader = function () {
        this.loading = this.loadingCtrl.create({
            content: 'Loading...'
        });
        this.loading.present();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_service_auth_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_service_user_data__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__update_patient_update_patient__ = __webpack_require__(286);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PatientListPage = (function () {
    ...
    PatientListPage.prototype.showUpdatePatient = function (patientID, p_last_name, p_first_name, p_language, p_timezone, p_mobile, p_alt_mobile, p_address, p_city, p_state, p_zip, p_country, p_notes, p_episode, p_referral_source, p_tracking_period) {
    ...
    PatientListPage.prototype.searchPatientData = function (form) {
        ...
        this.authService.searchPatient({ user_id: this.user_id, search: form.value.search }, 'search_patient')
            ...
            console.log(_this.hasSearchItems);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_paypal__ = __webpack_require__(289);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config__ = __webpack_require__(551);
...
var PayPalPage = (function () {
    function PayPalPage(toastCtrl, plt, payPal) {
        this.toastCtrl = toastCtrl;
        this.plt = plt;
        this.payPal = payPal;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__user_data__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__register_register__ = __webpack_require__(150);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_auth_service_user_data__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__forgot_password_forgot_password__ = __webpack_require__(284);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_service_user_data__ = __webpack_require__(21);
...
var ForgotPasswordPage = (function () {
    function ForgotPasswordPage(navCtrl, navParams, authService, alertCtrl, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authService = authService;
        this.alertCtrl = alertCtrl;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_patient_add_patient__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__add_manualevent_add_manualevent__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__alert_frequency_alert_frequency__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__patient_list_patient_list__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_auth_service_user_data__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var UpdatePatientPage = (function () {
    function UpdatePatientPage(navCtrl, navParams, authService, loadingCtrl, viewCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authService = authService;
        this.loadingCtrl = loadingCtrl;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chat_history_chat_history__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_service_auth_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_auth_service_user_data__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PatientStatusreportPage = (function () {
    function PatientStatusreportPage(navCtrl, navParams, authService, loadingCtrl, userdata, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.authService = authService;
        this.loadingCtrl = loadingCtrl;
    ...
    PatientStatusreportPage.prototype.showLoader = function () {
        this.loading = this.loadingCtrl.create({
            content: "Loading"
        });
        this.loading.present();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_auth_service_auth_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_login_login__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_register_register__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_register_terms_terms__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_profile_profile__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_notifications_notifications__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_settings_settings__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_tabs_tabs__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_add_manualevent_add_manualevent__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_add_patient_add_patient__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_alert_frequency_alert_frequency__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_patient_list_patient_list__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_patient_tab_patient_tab__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_patient_statusreport_patient_statusreport__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_chat_history_chat_history__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__ionic_native_unique_device_id__ = __webpack_require__(553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__ionic_native_device__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__services_patients__ = __webpack_require__(554);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__ionic_storage__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__providers_auth_service_user_data__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_edit_profile_edit_profile__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__ionic_cloud_angular__ = __webpack_require__(555);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_forgot_password_forgot_password__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_update_patient_update_patient__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_paypal_paypal_page__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_paypal_paypal_module__ = __webpack_require__(863);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__ionic_native_paypal__ = __webpack_require__(289);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_login_login__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_profile_profile__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_tabs_tabs__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_notifications_notifications__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_patient_tab_patient_tab__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_patient_statusreport_patient_statusreport__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_storage__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_settings_settings__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_add_patient_add_patient__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_patient_list_patient_list__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_alert_frequency_alert_frequency__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_add_manualevent_add_manualevent__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_auth_service_user_data__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_register_register__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_paypal_paypal_page__ = __webpack_require__(158);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, menuCtrl, storage, userData, events) {
        var _this = this;
        this.platform = platform;
        ...
        this.patientPages = [
            ...
            { title: 'Add Manual Event', name: 'PatientTabPage', component: __WEBPACK_IMPORTED_MODULE_8__pages_patient_tab_patient_tab__["a" /* PatientTabPage */], tabComponent: __WEBPACK_IMPORTED_MODULE_15__pages_add_manualevent_add_manualevent__["a" /* AddManualeventPage */], index: 3, icon: 'ios-calendar-outline' }
        ];
        this.loggedInPages = [
            ...
            { title: 'PayPal', name: 'PayPalPage', component: __WEBPACK_IMPORTED_MODULE_18__pages_paypal_paypal_page__["a" /* PayPalPage */], icon: 'settings' }
        ];
        this.loggedOutPages = [
...
Config.payPalEnvironmentSandbox = 'AdIVEf1ZD1z2cgSPuWO9fHMfYPgJrZbuu84nMWu2xwtQQdKYg4XRQhmkH8hsug7S-_Vzh-pcfg1aUMmG';
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"/Users/mobileapps/Desktop/BPCI-final/BPCI/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Ionic Blank\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  The world is your oyster.\n  <p>\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will be your guide.\n  </p>\n</ion-content>\n'/*ion-inline-end:"/Users/mobileapps/Desktop/BPCI-final/BPCI/src/pages/home/home.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]])
], HomePage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_service_user_data__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_auth_service_auth_service__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__edit_profile_edit_profile__ = __webpack_require__(283);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfilePage = (function () {
    ...
    ProfilePage.prototype.ngOnInit = function () {
        ...
        this.authService.getUserInfo({ user_id: this.id }, 'user_profile')
            .then(function (result) {
            _this.userDetails = result;
            if (_this.userDetails.response != undefined) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__paypal_page__ = __webpack_require__(158);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
